...
| :mag:      | <kbd><img src="./assets/gpt-manager-justmommies.png" alt="GPT Manager" width="150" /></kbd><kbd><img src="./assets/gpt-manager-targets-with-amazon.png" alt="GPT Manager with Amazon targets" width="300" /></kbd> | At Internet Brands I spent a lot of time with ads, including frontend and server tools, as well as patents involving our bidding solutions. One of the tools I created for ads is the GPTManager monitor tool to inspect and validate expected page ads |
