...
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| :bank:      | <kbd><a href="https://www.cobank.com"><img src="./assets/cobank.png" alt="Cobank banking portal" width="150" /><a></kbd>                                                                                                                           | With the Ash Group I was a major contributor, as a Scaled Agile Framework (SAFe) team lead, to the creation and launching the CoBank banking portal.                                                                                                       |
| :apple:     | <kbd><a href="https://foodrevolution.org"><img src="./assets/FRN-forum-desktop.png" alt="Food Revolution Network" width="150" /></a></kbd>                                                                                                         | At Food Revolution Network I created a scalable, themed React NativeBase community forum, launched in under 8 months, enhancing community engagement with feature-rich tools.                                                                              |
| :hospital:  | <kbd><a href="https://www.webmdrx.com"><img src="./assets/webmdrx.png" alt="WebMD Rx site" width="150" /></a></kbd>                                                                                                                                | At WebMD I Rearchitected and enhanced vital WebMD Rx pages from Angular to Vue, addding enhancements like SEO and auto regeneration of the sitemap.                                                                                                        |
| :mag:       | <kbd><img src="./assets/Internet-Brands-gpt-manager-justmommies.png" alt="GPT Manager" width="150" /></kbd><kbd><img src="./assets/Internet-Brands-gpt-manager-targets-with-amazon.png" alt="GPT Manager with Amazon targets" width="150" /></kbd> | With Internet Brands I spent a lot of time with ads, including frontend and server tools, as well as patents involving our bidding solutions. One of the tools I created for ads is the GPTManager monitor tool to inspect and validate expected page ads. |
| :clipboard: | <kbd><img src="./assets/Internet-Brands-vbulletin.png" alt="GPT Manager" width="150" /></kbd>                                                                                                                                                      | Introduced [responsive design](https://ethanmarcotte.com/books/responsive-web-design/) to Internet Brands through a major UI upgrade of the [vBulletin](https://www.vbulletin.com) Forum                                                                   |
| :iphone:    | <kbd><img src="./assets/Internet-Brands-pcuk.png" alt="GPT Manager" width="150" /></kbd>                                                                                                                                                           | While leading the Mobile Team at Internet Brands I managed a group of engineers responsible for overhauling and optimizing many of Internet Brands' hundreds of web properties.                                                                            |
...
I became the owner of the New Hire Advisor SharePoint Team Site, as well as helping the Core Sharepoint team.  
