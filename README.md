...
| :mag:      | <kbd><img src="./assets/gpt-manager-justmommies.png" alt="GPT Manager" width="150" /></kbd><kbd><img src="./assets/gpt-manager-targets-with-amazon.png" alt="GPT Manager with Amazon targets" width="300" /></kbd> | Created the GPTManager Monitor tool to inspect and validate expected page ads<br>company: Internet Brands                                     |
